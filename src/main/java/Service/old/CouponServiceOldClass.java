...
//
//@Service
//public class CouponServiceOldClass {
//
//    @Autowired
//    private final CouponRepository couponRepository;
//
//    @Autowired
//    public CouponServiceOldClass(CouponRepository couponRepository) {
...
//
//    public Coupon getCouponById(Integer coupon1Id) throws CouponNotFoundException {
//        return couponRepository.findById(couponId)
//                .orElseThrow(() -> new CouponNotFoundException(ErrMsg.COUPON_NOT_FOUND.getMsg()));
//    }
//
